...
function secret(_0x141a71, _0x433196, _0x45cf51) {
    _0x433196 = CryptoJS["MD5"](_0x433196)['toString']();
    var iv = CryptoJS['enc']["Utf8"]["parse"](_0x433196['substring'](0,16));
    var key = CryptoJS['enc']["Utf8"]['parse'](_0x433196['substring'](16));
	url =  CryptoJS["AES"]["decrypt"](_0x141a71, key, {
		'iv': iv,
...
function get_url(_pr,_pu,url){
	var _pr = _pr; //$('meta[name="viewport"]').attr('id').replace('vod_', ''); vod_vFu228FnGM
	var _pu = _pu; //$('meta[charset="UTF-8"]').attr('id').replace('vod_', ''); //vod_9481675032
	var _puArr = [];
	var _newArr = [];
	var _code = '';
