...
function rsaFingerprint(a, b) {
    var c = '{"user_agent":"Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/72.0.3626.121 Saf","language":"zh-CN","color_depth":"24","pixel_ratio":"1","hardware_concurrency":"8","resolution":"1920,1080","available_resolution":"1920,1040","timezone_offset":"-480","session_storage":"1","local_storage":"1","indexed_db":"1","open_database":"1","cpu_class":"unknown","navigator_platform":"Win32","do_not_track":"unknown","regular_plugins":"Chromium PDF Plugin::Portable Document Format::application/x-google-chrome-pdf~pdf,Chromium PDF View","webgl_vendor":"Google Inc.~ANGLE (Intel(R) UHD Graphics 630 Direct3D11 vs_5_0 ps_5_0)","adblock":"false","has_lied_languages":"false","has_lied_resolution":"false","has_lied_os":"false","has_lied_browser":"false","touch_support":"0,false,false","js_fonts":"Arial,Arial Black,Arial Narrow,Calibri,Cambria,Cambria Math,Comic Sans MS,Consolas,Courier,Courier N"}',
        d = "debe6fce5f676c2a9978c9849b0ff54b",
        e = c.length,
        f = "",
        g = new db;
    g.setPublic(a, b);
...
function getpwd(user,pwd) {
    data = {};
    modulus =
        "";
    publicExponent = "010001";
    c = new db;
    c.setPublic(modulus, publicExponent);
    data.password = c.encrypt(pwd)
    data.loginid = c.encrypt(user)
    var d = rsaFingerprint(modulus,publicExponent)
