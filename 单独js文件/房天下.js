...
function arrayCopy(n, t, i, r, u) {
    for (var o = Math.min(t + u, n.length), f = t, e = r; f < o; ++f, ++e)
    i[e] = n[f]
}
...
function biCompare(n, t) {
    ...
    if (n.digits[i] != t.digits[i]) return n.isNeg ? 1 - 2 * Number(n.digits[i] > t.digits[i]) : 1 - 2 * Number(n.digits[i] < t.digits[i]);
    return 0
}
...
function biDivideModulo(n, t) {
    var a = biNumBits(n),
        ...
        v = t.isNeg,
        r, i, u, e, h, o, f, y, p;
    if (a < s) return n.isNeg ? (r = biCopy(bigOne),
    r.isNeg = !t.isNeg,
    n.isNeg = !1,
    t.isNeg = !1,
    i = biSubtract(t, n),
    ...
    t = biShiftLeft(t, 1), ++e, ++s,
    u = Math.ceil(s / bitsPerDigit) - 1;
    for (i = biShiftLeft(i, e),
    a += e,
    h = Math.ceil(a / bitsPerDigit) - 1,
    o = biMultiplyByRadixPower(t, h - u); biCompare(i, o) != -1;)++r.digits[h - u],
    i = biSubtract(i, o);
    for (f = h; f > u; --f) {
        ...
        p = c * biRadixSquared + (w * biRadix + b); y > p;)--r.digits[f - u - 1],
        y = r.digits[f - u - 1] * (l * biRadix | k),
    ...
    t = biShiftRight(t, e),
    i = biSubtract(t, i)),
    i.digits[0] == 0 && biHighIndex(i) == 0 && (i.isNeg = !1), [r, i]
}
...
function biPowMod(n, t, i) {
    for (var f = bigOne, u = n, r = t;;) {
        ...
        r = biShiftRight(r, 1),
        r.digits[0] == 0 && biHighIndex(r) == 0) break;
...
function BarrettMu_powMod(n, t) {
    ...
    i = t;;) {
        ...
        i = biShiftRight(i, 1),
        i.digits[0] == 0 && biHighIndex(i) == 0) break;
...
function getpwd(pwd) {
    var password = encryptedString(key_to_encode, pwd);
    return password;
}