//http://passport.xueyiyun.com/login?returnUrl=http://www.xueyiyun.com%2f
...
var lookup = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", dpl10, lr10, hexatrigesimalToChar, hexToChar, highBitMasks, lowBitMasks, RSAAPP;
(function(n) {
    "use strict";
    function t(n) {
...
function getpwd(pwd){
    var publickey = "";
    setMaxDigits(262);
    var key = new RSAKeyPair("010001", "", publickey, 2048);
    var ciphertext = encryptedString(key, pwd, RSAAPP.PKCS1Padding, RSAAPP.RawEncoding);
    p = base64js.fromByteArray(ciphertext);
